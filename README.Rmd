...
```
Published on CRAN `r packageDate("replicateBE", date.fields = "Date/Publication")` (version `r packageVersion("replicateBE")` built `r packageDate("replicateBE", date.fields = "Built")` with R `r substr(packageDescription("replicateBE", fields = "Built"), 3, 7)`).
