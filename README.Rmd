...
### Examples
  - Evaluate the internal reference dataset 01 of [Annex II](https://www.ema.europa.eu/en/documents/other/31-annex-ii-statistical-analysis-bioequivalence-study-example-data-set_en.pdf "EMA, 21 September 2016") by Method A.
...
```
  ...
  - Same dataset evaluated by Method B. Perform outlier assessment, recalculate _CV~wR~_ after exclusion of outliers, new expanded limits.
