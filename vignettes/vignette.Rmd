...
In order to avoid discontinuities due to double rounding, expanded limits are calculated in full numeric precision and only the CI is rounded according to the GL.
