...
where $\small{\theta_0=\mu_T/\mu_R}$ and the Null hypothesis is <u>in</u>equivalence. In Average Bioequivalence the limits $\small{[L,U]}$ are fixed, whereas in ABEL they can be [expanded](#BElim) based on the variability of the reference treatment.
...
| #2 | Estimation of *CV~wT~* | 13 who received 2 treatments `T` | 1, 6, 8 |
