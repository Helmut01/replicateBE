...
In order to avoid small discontinuities at _CV~wR~_ ≈ 50% (due to double rounding), the expanded limits are calculated in full numeric precision and only the CI is rounded according to the GL.
