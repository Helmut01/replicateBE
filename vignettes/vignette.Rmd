...
where $\small{\theta_0=\mu_\textrm{T}/\mu_\textrm{R}}$ and the Null hypothesis is **in**equivalence. In Average Bioequivalence (ABE) the limits $\small{[L,U]}$ are fixed, whereas in <abbr title="Average Bioequivalence with Expanding Limits">ABEL</abbr> they can be [expanded](#BElim) based on the within-subject variability of the reference treatment.
